package com.temsquare.recruit.service;


import com.temsquare.recruit.dao.EnterpriseDao;
import com.temsquare.recruit.dao.RecruitDao;
...
public class RecruitService {
    ...
    {
        //条件
        Specification<Recruit> specification
                = createSpecification(whereMap);
        //容器
     ...
     *
     */
    public List<Recruit> findSearch(Map whereMao)
    {
        Specification<Recruit> specification = createSpecification(whereMao);
